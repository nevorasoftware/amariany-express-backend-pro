...
COMMENT ON TABLE "Seller" IS 'Tabla para el registro y mantenimiento de Clientes / Vendedores';
COMMENT ON COLUMN "Seller"."estado" IS 'Estado del vendedor: ACTIVO o INACTIVO (Modificable sólo en mantenimiento/edición)';
